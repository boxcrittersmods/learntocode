...
Blockly.utils.style.getStyle_ = function(a, b) {
  return (
    Blockly.utils.style.getComputedStyle(a, b) ||
    Blockly.utils.style.getCascadedStyle(a, b) ||
    (a.style && a.style[b])
  );
};
...
Blockly.utils.style.getPageOffset = function(a) {
  ...
  c = new Blockly.utils.Coordinate(
...
Blockly.Events.disableOrphans = function(a) {
  if (
    (a.type == Blockly.Events.MOVE || a.type == Blockly.Events.CREATE) &&
    a.workspaceId
  ) {
...
Blockly.utils.xml.createElement = function(a) {
  return Blockly.utils.xml
    .document()
    .createElementNS(Blockly.utils.xml.NAME_SPACE, a);
};
...
Blockly.Xml.blockToDom = function(a, b) {
  ...
  if ((e = a.getNextBlock()))
    (h = Blockly.utils.xml.createElement("next")),
      h.appendChild(Blockly.Xml.blockToDom(e, b)),
      c.appendChild(h);
  ...
  for (var c = (a = a.cloneNode(!0)), d; c; )
    if ((b && "shadow" == c.nodeName && c.removeAttribute("id"), c.firstChild))
      ...
      for (; c && !c.nextSibling; )
        (d = c),
          (c = c.parentNode),
          d.nodeType == Blockly.utils.dom.Node.TEXT_NODE &&
            "" == d.data.trim() &&
            c.firstChild != d &&
  ...
  for (var g; (g = a.childNodes[e]); e++)
    if (g.nodeType != Blockly.utils.dom.Node.TEXT_NODE) {
      for (var h = (f = null), k = 0, l; (l = g.childNodes[k]); k++)
        l.nodeType == Blockly.utils.dom.Node.ELEMENT_NODE &&
      ...
      switch (g.nodeName.toLowerCase()) {
        ...
        case "comment":
          ...
          isNaN(k) ||
            isNaN(g) ||
            (c.commentModel.size = new Blockly.utils.Size(k, g));
          h &&
            c.getCommentIcon &&
            !c.isInFlyout &&
            setTimeout(function() {
...
Blockly.Connection.prototype.getParentInput = function() {
  for (
    var a = null, b = this.sourceBlock_, c = b.inputList, d = 0;
    d < b.inputList.length;
    d++
  )
...
Blockly.Extensions.unregister = function(a) {
  Blockly.Extensions.ALL_[a]
    ? delete Blockly.Extensions.ALL_[a]
    : console.warn(
...
Blockly.Scrollbar.prototype.createDom_ = function(a) {
  ...
  this.workspace_
    .getThemeManager()
    .subscribe(this.svgHandle_, "scrollbar", "fill");
  this.workspace_
    .getThemeManager()
...
Blockly.Cursor.prototype.next = function() {
  ...
  for (
    ...
    a &&
    a.next() &&
    (a.getType() == Blockly.ASTNode.types.NEXT ||
      a.getType() == Blockly.ASTNode.types.BLOCK);
...
Blockly.Cursor.prototype["in"] = function() {
  ...
  if (!a) return null;
  if (
    a.getType() == Blockly.ASTNode.types.PREVIOUS ||
    a.getType() == Blockly.ASTNode.types.OUTPUT
  )
    a = a.next();
...
Blockly.Theme.prototype.getComponentStyle = function(a) {
  return (a = this.componentStyles_[a]) &&
    "string" == typeof propertyValue &&
    this.getComponentStyle(a)
    ? this.getComponentStyle(a)
    : a
    ? String(a)
    : null;
...
Blockly.Workspace.prototype.refreshTheme = function() {
  this.updateBlockStyles_(
    this.getAllBlocks().filter(function(a) {
...
Blockly.FlyoutDragger.prototype.drag = function(a) {
  ...
  this.horizontalLayout_
    ? this.scrollbar_.set(-a.x)
    : this.scrollbar_.set(-a.y);
};
Blockly.Tooltip = {};
...
Blockly.Gesture.prototype.doStart = function(a) {
  Blockly.utils.isTargetInput(a)
    ...
    : ((this.hasStarted_ = !0),
      ...
      this.targetBlock_ &&
        (!this.targetBlock_.isInFlyout && a.shiftKey
  ...
  this.isEnding_
    ...
    : ((this.isEnding_ = !0),
      this.isDraggingBubble_
        ...
        : this.isBlockClick_()
        ? this.doBlockClick_()
        : this.isWorkspaceClick_() && this.doWorkspaceClick_(a),
      a.preventDefault(),
      a.stopPropagation(),
      this.dispose());
};
...
Blockly.Gesture.prototype.doWorkspaceClick_ = function(a) {
  ...
  a.shiftKey
    ? (Blockly.navigation.enableKeyboardAccessibility(),
      (a = new Blockly.utils.Coordinate(a.clientX, a.clientY)),
      (a = Blockly.utils.screenToWsCoordinates(b, a)),
      (a = Blockly.ASTNode.createWorkspaceNode(b, a)),
      b.getCursor().setCurNode(a))
    : Blockly.selected && Blockly.selected.unselect();
};
...
Blockly.Field.prototype.configure_ = function(a) {
  var b = a.tooltip;
  "string" == typeof b &&
    (b = Blockly.utils.replaceMessageReferences(a.tooltip));
  b && this.setTooltip(b);
};
...
Blockly.Field.prototype.updateSize_ = function() {
  ...
  this.borderRect_ &&
    ((a += Blockly.Field.X_PADDING), this.borderRect_.setAttribute("width", a));
  this.size_.width = a;
};
...
Blockly.Field.prototype.setCursorSvg = function(a) {
  a
    ? (this.fieldGroup_.appendChild(a), (this.cursorSvg_ = a))
    : (this.cursorSvg_ = null);
};
Blockly.Field.prototype.setMarkerSvg = function(a) {
  a
    ? (this.fieldGroup_.appendChild(a), (this.markerSvg_ = a))
...
Blockly.fieldRegistry.register = function(a, b) {
  ...
  if (Blockly.fieldRegistry.typeMap_[a])
...
Blockly.fieldRegistry.unregister = function(a) {
  Blockly.fieldRegistry.typeMap_[a]
    ? delete Blockly.fieldRegistry.typeMap_[a]
...
Blockly.Block.prototype.unplugFromRow_ = function(a) {
  ...
  if (
    ...
    if (((a = a.targetConnection), a.disconnect(), a.checkType_(b)))
      b.connect(a);
...
Blockly.Block.prototype.getColourShadow = function() {
  ...
  return a ? a : Blockly.utils.colour.blend("#fff", this.getColour(), 0.6);
};
Blockly.Block.prototype.getColourBorder = function() {
  ...
  return {
    colourBorder: null,
    colourLight: Blockly.utils.colour.blend("#fff", a, 0.3),
    colourDark: Blockly.utils.colour.blend("#000", a, 0.2)
  };
};
        ...
        if (((h = !1), "string" == typeof e)) f = new Blockly.FieldLabel(e);
          ...
          switch (e.type) {
            ...
            case "input_dummy":
              ...
              break;
            default:
              (f = Blockly.fieldRegistry.fromJson(e)),
                !f && e.alt && ((e = e.alt), (h = !0));
          }
      while (h);
...
Blockly.Component.prototype.addChildAt = function(a, b, c) {
  ...
  a.inDocument_ && this.inDocument_ && a.getParent() == this
    ...
    : this.inDocument_ &&
      ...
      a.element_.parentNode.nodeType == Blockly.utils.dom.Node.ELEMENT_NODE &&
      a.enterDocument();
};
...
Blockly.Component.prototype.forEachChild = function(a, b) {
  for (var c = 0; c < this.children_.length; c++)
...
Blockly.utils.aria.setRole = function(a, b) {
  b
    ...
    : Blockly.utils.aria.removeRole(a);
};
...
Blockly.Menu.prototype.setHighlightedIndex = function(a) {
  ...
  b
    ? (b.setHighlighted(!0), (this.highlightedIndex_ = a))
    : -1 < this.highlightedIndex_ &&
      (this.getHighlighted().setHighlighted(!1), (this.highlightedIndex_ = -1));
  b &&
...
Blockly.Menu.prototype.handleMouseOver_ = function(a) {
  (a = this.getMenuItem(a.target)) &&
    a.isEnabled() &&
    this.getHighlighted() !== a &&
    (this.unhighlightCurrent(), this.setHighlighted(a));
};
...
Blockly.Menu.prototype.handleKeyEvent = function(a) {
  return 0 != this.getChildCount() && this.handleKeyEventInternal(a)
...
Blockly.MenuItem.prototype.setChecked = function(a) {
  if (this.checkable_) {
    ...
    b &&
      this.isEnabled() &&
      (a
        ? (Blockly.utils.dom.addClass(b, "goog-option-selected"),
          Blockly.utils.aria.setState(b, Blockly.utils.aria.State.SELECTED, !0))
        : (Blockly.utils.dom.removeClass(b, "goog-option-selected"),
          Blockly.utils.aria.setState(
            b,
            Blockly.utils.aria.State.SELECTED,
            !1
...
Blockly.MenuItem.prototype.setHighlighted = function(a) {
  ...
  b &&
    this.isEnabled() &&
    (a
      ? Blockly.utils.dom.addClass(b, "goog-menuitem-highlight")
...
Blockly.MenuItem.prototype.setEnabled = function(a) {
  ...
  (a = this.getElement()) &&
    (this.enabled_
      ? Blockly.utils.dom.removeClass(a, "goog-menuitem-disabled")
      : Blockly.utils.dom.addClass(a, "goog-menuitem-disabled"));
};
...
Blockly.RenderedConnection.prototype.highlight = function() {
  ...
  a =
    this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE
      ? Blockly.utils.svgPaths.moveBy(0, -5) +
        Blockly.utils.svgPaths.lineOnAxis("v", 5) +
        a.PUZZLE_TAB.pathDown +
        Blockly.utils.svgPaths.lineOnAxis("v", 5)
      : Blockly.utils.svgPaths.moveBy(-5, 0) +
        Blockly.utils.svgPaths.lineOnAxis("h", 5) +
        a.NOTCH.pathLeft +
        Blockly.utils.svgPaths.lineOnAxis("h", 5);
...
Blockly.Warning.prototype.setVisible = function(a) {
  a != this.isVisible() &&
    ...
    a ? this.createBubble() : this.disposeBubble());
};
Blockly.Warning.prototype.createBubble = function() {
  ...
  if (this.block_.RTL)
    for (
      var a = this.paragraphElement_.getBBox().width, b = 0, c;
      (c = this.paragraphElement_.childNodes[b]);
      b++
    )
      c.setAttribute("text-anchor", "end"),
        c.setAttribute("x", a + Blockly.Bubble.BORDER_WIDTH);
  this.updateColour();
};
...
Blockly.BlockSvg.prototype.createTabList_ = function() {
  for (var a = [], b = 0, c; (c = this.inputList[b]); b++) {
    for (var d = 0, e; (e = c.fieldRow[d]); d++)
      e.isTabNavigable() && e.isVisible() && a.push(e);
    c.connection && (c = c.connection.targetBlock()) && a.push(c);
  }
  return a;
};
...
Blockly.BlockSvg.prototype.setCommentText = function(a) {
  ...
  this.commentModel.text != a &&
    (Blockly.BlockSvg.superClass_.setCommentText.call(this, a),
    (a = null != a),
    !!this.commentIcon_ == a
  ...
  if (this.workspace.isDragging()) {
    ...
    "string" == typeof a
      ...
      : this.warning &&
        ...
        (d = d != f));
    d && this.rendered && (this.render(), this.bumpNeighbours());
  }
};
...
Blockly.BlockSvg.prototype.positionNearConnection = function(a, b) {
  (a.type != Blockly.NEXT_STATEMENT && a.type != Blockly.INPUT_VALUE) ||
    this.moveBy(b.x_ - a.x_, b.y_ - a.y_);
};
...
Blockly.BlockSvg.prototype.setCursorSvg = function(a) {
  a
    ? (this.svgGroup_.appendChild(a), (this.cursorSvg_ = a))
    : (this.cursorSvg_ = null);
};
Blockly.BlockSvg.prototype.setMarkerSvg = function(a) {
  a
    ? (this.cursorSvg_
        ? this.svgGroup_.insertBefore(a, this.cursorSvg_)
...
Blockly.DropDownDiv.getPositionMetrics = function(a, b, c, d) {
  ...
  return b + f.height < e.bottom
    ? Blockly.DropDownDiv.getPositionBelowMetrics(a, b, e, f)
    : d - f.height > e.top
    ? Blockly.DropDownDiv.getPositionAboveMetrics(c, d, e, f)
    : b + f.height < document.documentElement.clientHeight
    ? Blockly.DropDownDiv.getPositionBelowMetrics(a, b, e, f)
    : d - f.height > document.documentElement.clientTop
    ? Blockly.DropDownDiv.getPositionAboveMetrics(c, d, e, f)
    : Blockly.DropDownDiv.getPositionTopOfPageMetrics(a, e, f);
};
...
Blockly.DropDownDiv.getPositionX = function(a, b, c, d) {
  ...
  d = Blockly.utils.math.clamp(
    b,
    e - a,
    d - b - Blockly.DropDownDiv.ARROW_SIZE
  );
...
Blockly.Options.parseZoomOptions_ = function(a) {
  ...
  b.minScale = void 0 === a.minScale ? 0.3 : Number(a.minScale);
...
Blockly.blockRendering.register = function(a, b) {
  if (Blockly.blockRendering.rendererMap_[a])
...
Blockly.blockRendering.unregister = function(a) {
  Blockly.blockRendering.rendererMap_[a]
    ? delete Blockly.blockRendering.rendererMap_[a]
    : console.warn(
...
Blockly.blockRendering.init = function(a) {
  if (!Blockly.blockRendering.rendererMap_[a])
    throw Error("Renderer not registered: ", a);
  var b = function() {
...
Blockly.WorkspaceSvg.prototype.setCursorSvg = function(a) {
  a
    ? this.svgBlockCanvas_ &&
      (this.svgBlockCanvas_.appendChild(a), (this.cursorSvg_ = a))
    : (this.cursorSvg_ = null);
};
Blockly.WorkspaceSvg.prototype.setMarkerSvg = function(a) {
  a
    ? this.svgBlockCanvas_ &&
      (this.cursorSvg_
        ? this.svgBlockCanvas_.insertBefore(a, this.cursorSvg_)
        : this.svgBlockCanvas_.appendChild(a),
      (this.markerSvg_ = a))
    : (this.markerSvg_ = null);
};
...
Blockly.WorkspaceSvg.prototype.createDom = function(a) {
  ...
  a &&
    ...
    "blocklyMainBackground" == a && this.grid_
...
Blockly.WorkspaceSvg.prototype.setVisible = function(a) {
  ...
  if (a) {
    for (var b = this.getAllBlocks(!1), c = b.length - 1; 0 <= c; c--)
      b[c].markDirty();
    this.render();
    this.toolbox_ && this.toolbox_.position();
    ...
    if (!isNaN(d) && !isNaN(e)) {
      ...
      do {
        ...
        if (!a) {
          ...
          for (var l; (l = k[c]); c++)
            if (
              l.closest(Blockly.SNAP_RADIUS, new Blockly.utils.Coordinate(d, e))
                .connection
            ) {
              a = !0;
              break;
        ...
        a &&
          ((d = this.RTL ? d - Blockly.SNAP_RADIUS : d + Blockly.SNAP_RADIUS),
          (e += 2 * Blockly.SNAP_RADIUS));
      } while (a);
      b.moveBy(d, e);
    }
  } finally {
...
Blockly.ASTNode.createConnectionNode = function(a) {
  return a
    ? a.type == Blockly.INPUT_VALUE ||
      (a.type == Blockly.NEXT_STATEMENT && a.getParentInput())
      ? Blockly.ASTNode.createInputNode(a.getParentInput())
      : a.type == Blockly.NEXT_STATEMENT
      ? new Blockly.ASTNode(Blockly.ASTNode.types.NEXT, a)
      : a.type == Blockly.OUTPUT_VALUE
      ? new Blockly.ASTNode(Blockly.ASTNode.types.OUTPUT, a)
      : a.type == Blockly.PREVIOUS_STATEMENT
      ? new Blockly.ASTNode(Blockly.ASTNode.types.PREVIOUS, a)
      : null
    : null;
};
Blockly.ASTNode.createInputNode = function(a) {
  return a
    ? new Blockly.ASTNode(Blockly.ASTNode.types.INPUT, a.connection)
    : null;
};
...
Blockly.ASTNode.prototype.findTopASTNodeForBlock_ = function(a) {
  ...
  return b
    ? Blockly.ASTNode.createConnectionNode(b)
    : Blockly.ASTNode.createBlockNode(a);
};
Blockly.ASTNode.prototype.getOutAstNodeForBlock_ = function(a) {
  if (!a) return null;
  a = a.getTopStackBlock();
  var b = a.previousConnection || a.outputConnection;
  return b && b.targetConnection && b.targetConnection.getParentInput()
    ? Blockly.ASTNode.createInputNode(b.targetConnection.getParentInput())
    : Blockly.ASTNode.createStackNode(a);
};
...
Blockly.ASTNode.prototype.prev = function() {
  switch (this.type_) {
    ...
    case Blockly.ASTNode.types.BLOCK:
      ...
      if ((a = this.location_.previousConnection || a))
        return Blockly.ASTNode.createConnectionNode(a);
      break;
    case Blockly.ASTNode.types.PREVIOUS:
...
Blockly.ASTNode.prototype.out = function() {
  switch (this.type_) {
    case Blockly.ASTNode.types.STACK:
      ...
      a = new Blockly.utils.Coordinate(
        a.x,
        a.y + Blockly.ASTNode.DEFAULT_OFFSET_Y
      );
      return Blockly.ASTNode.createWorkspaceNode(this.location_.workspace, a);
    case Blockly.ASTNode.types.OUTPUT:
      return (a = this.location_.targetConnection)
        ? Blockly.ASTNode.createConnectionNode(a)
...
Blockly.user.keyMap.serializeKeyEvent = function(a) {
  for (
    var b = Blockly.utils.object.values(Blockly.user.keyMap.modifierKeys),
      c = "",
      d = 0,
      e;
    (e = b[d]);
...
Blockly.user.keyMap.createDefaultKeyMap = function() {
  var a = {},
    b = Blockly.user.keyMap.createSerializedKey(Blockly.utils.KeyCodes.K, [
...
Blockly.navigation.focusFlyout_ = function() {
  ...
  b &&
    b.getWorkspace() &&
    ((a = b.getWorkspace().getTopBlocks(!0)),
    0 < a.length &&
      ((a = a[0]),
      (a = Blockly.ASTNode.createStackNode(a)),
      Blockly.navigation.getFlyoutCursor_().setCurNode(a)));
};
Blockly.navigation.focusWorkspace_ = function() {
  ...
  Blockly.navigation.currentState_ = Blockly.navigation.STATE_WS;
  0 < d.length
    ? b.setCurNode(Blockly.navigation.getTopNode(d[0]))
    : ((c = new Blockly.utils.Coordinate(100, 100)),
      (a = Blockly.ASTNode.createWorkspaceNode(a, c)),
      b.setCurNode(a));
};
Blockly.navigation.getFlyoutCursor_ = function() {
  var a = Blockly.getMainWorkspace(),
    b = null;
  a.rendered &&
    (b = (a = (b = a.getToolbox()) ? b.flyout_ : a.getFlyout())
      ? a.workspace_.getCursor()
      : null);
  return b;
};
Blockly.navigation.insertFromFlyout = function() {
  ...
  if (b && b.isVisible()) {
    ...
    c.isEnabled()
      ? ((b = b.createBlock(c)),
        b.render(),
        b.setConnectionsHidden(!1),
        a.getCursor().setCurNode(Blockly.ASTNode.createBlockNode(b)),
        ...
        a.getCursor().setCurNode(Blockly.navigation.getTopNode(b)),
...
Blockly.navigation.modifyWarn_ = function() {
  ...
  a = a.getType();
  b = b.getType();
  return a == Blockly.ASTNode.types.FIELD
    ? (Blockly.navigation.warn_("Should not have been able to mark a field."),
      !1)
    : a == Blockly.ASTNode.types.BLOCK
    ? (Blockly.navigation.warn_("Should not have been able to mark a block."),
      !1)
    : a == Blockly.ASTNode.types.STACK
    ? (Blockly.navigation.warn_("Should not have been able to mark a stack."),
      !1)
    : b == Blockly.ASTNode.types.FIELD
    ? (Blockly.navigation.warn_("Cannot attach a field to anything else."), !1)
    : b == Blockly.ASTNode.types.WORKSPACE
...
Blockly.navigation.modify_ = function() {
  ...
  if (
    a.isConnection() &&
    (d == Blockly.ASTNode.types.BLOCK || d == Blockly.ASTNode.types.STACK)
  )
    return Blockly.navigation.insertBlock(e, f);
  if (c == Blockly.ASTNode.types.WORKSPACE)
    return (
      (b = Blockly.navigation.getSourceBlock_(b)),
      Blockly.navigation.moveBlockToWorkspace_(b, a)
    );
...
Blockly.navigation.disconnectChild_ = function(a, b) {
  var c = a.getSourceBlock(),
    d = b.getSourceBlock();
  c.getRootBlock() == d.getRootBlock() &&
    (-1 < c.getDescendants(!1).indexOf(d)
      ? Blockly.navigation.getInferiorConnection_(b).disconnect()
      : Blockly.navigation.getInferiorConnection_(a).disconnect());
};
Blockly.navigation.moveAndConnect_ = function(a, b) {
  if (!a || !b) return !1;
  var c = a.getSourceBlock();
  return b.canConnectWithReason_(a) == Blockly.Connection.CAN_CONNECT
    ? (Blockly.navigation.disconnectChild_(a, b),
      b.isSuperior() || c.getRootBlock().positionNearConnection(a, b),
      b.connect(a),
      !0)
    : !1;
};
...
Blockly.navigation.connect_ = function(a, b) {
  ...
  if (
    (c && d && Blockly.navigation.moveAndConnect_(c, d)) ||
    (e && f && Blockly.navigation.moveAndConnect_(e, f)) ||
    Blockly.navigation.moveAndConnect_(a, b)
  )
    return !0;
  try {
    ...
    case Blockly.OUTPUT_VALUE:
      for (var c = 0; c < a.inputList.length; c++) {
        ...
        if (
          ...
          Blockly.navigation.connect_(d, b)
        )
          return !0;
      }
      if (
        a.outputConnection &&
        Blockly.navigation.connect_(a.outputConnection, b)
      )
        return !0;
  }
  Blockly.navigation.warn_(
...
Blockly.navigation.disconnectBlocks_ = function() {
  ...
  if (b.isConnection()) {
    var c = b.getLocation();
    c.isConnected()
      ? ((b = c.isSuperior() ? c : c.targetConnection),
        (c = c.isSuperior() ? c.targetConnection : c),
        c.getSourceBlock().isShadow()
          ...
          : (b.disconnect(),
            ...
            b
              ...
              .getRootBlock()
              .bringToFront(),
            (b = Blockly.ASTNode.createConnectionNode(b)),
            a.getCursor().setCurNode(b)))
...
Blockly.navigation.getSourceBlock_ = function(a) {
  return a
    ? a.getType() === Blockly.ASTNode.types.BLOCK
      ? a.getLocation()
      : a.getType() === Blockly.ASTNode.types.STACK
      ? a.getLocation()
      : a.getType() === Blockly.ASTNode.types.WORKSPACE
      ? null
      : a.getLocation().getSourceBlock()
    : null;
};
...
Blockly.navigation.moveCursorOnBlockDelete = function(a) {
  ...
  if (b && (b = b.getCursor())) {
    ...
    c === a
      ? c.getParent()
        ? (a = c.previousConnection || c.outputConnection) &&
          b.setCurNode(Blockly.ASTNode.createConnectionNode(a.targetConnection))
        : b.setCurNode(
...
Blockly.navigation.enableKeyboardAccessibility = function() {
  Blockly.keyboardAccessibilityMode ||
    ((Blockly.keyboardAccessibilityMode = !0),
    Blockly.navigation.focusWorkspace_());
};
...
Blockly.navigation.log_ = function(a) {
  Blockly.navigation.loggingCallback
    ? Blockly.navigation.loggingCallback("log", a)
    : console.log(a);
};
Blockly.navigation.warn_ = function(a) {
  Blockly.navigation.loggingCallback
    ? Blockly.navigation.loggingCallback("warn", a)
    : console.warn(a);
};
Blockly.navigation.error_ = function(a) {
  Blockly.navigation.loggingCallback
    ? Blockly.navigation.loggingCallback("error", a)
    : console.error(a);
};
Blockly.navigation.onKeyPress = function(a) {
  a = Blockly.user.keyMap.serializeKeyEvent(a);
  return (a = Blockly.user.keyMap.getActionByKeyCode(a))
    ? Blockly.navigation.onBlocklyAction(a)
    : !1;
};
Blockly.navigation.onBlocklyAction = function(a) {
  ...
  Blockly.keyboardAccessibilityMode
    ? b
      ? -1 < Blockly.navigation.READONLY_ACTION_LIST.indexOf(a) &&
        (c = Blockly.navigation.handleActions_(a))
      : (c = Blockly.navigation.handleActions_(a))
    : a.name === Blockly.navigation.actionNames.TOGGLE_KEYBOARD_NAV &&
      (Blockly.navigation.enableKeyboardAccessibility(), (c = !0));
  return c;
};
Blockly.navigation.handleActions_ = function(a) {
  var b = Blockly.getMainWorkspace();
  if (a.name === Blockly.navigation.actionNames.TOGGLE_KEYBOARD_NAV)
    return Blockly.navigation.disableKeyboardAccessibility(), !0;
  if (a.name === Blockly.navigation.actionNames.TOOLBOX)
    return (
      b.getToolbox()
  ...
  if (Blockly.navigation.currentState_ === Blockly.navigation.STATE_WS) {
    ...
    var c = !1;
    b &&
      b.getType() === Blockly.ASTNode.types.FIELD &&
      (c = b.getLocation().onBlocklyAction(a));
    c || (c = Blockly.navigation.workspaceOnAction_(a));
    return c;
  }
  return Blockly.navigation.currentState_ === Blockly.navigation.STATE_FLYOUT
    ? Blockly.navigation.flyoutOnAction_(a)
    : Blockly.navigation.currentState_ === Blockly.navigation.STATE_TOOLBOX
    ? Blockly.navigation.toolboxOnAction_(a)
    : !1;
};
...
Blockly.navigation.toolboxOnAction_ = function(a) {
  if (a.name === Blockly.navigation.actionNames.EXIT)
    return Blockly.navigation.focusWorkspace_(), !0;
  var b = Blockly.getMainWorkspace()
    .getToolbox()
    .onBlocklyAction(a);
  return b || a.name !== Blockly.navigation.actionNames.IN
    ? b
...
Blockly.navigation.handleEnterForWS_ = function() {
  var a = Blockly.getMainWorkspace()
    ...
    b = a.getType();
  b == Blockly.ASTNode.types.FIELD
    ? a.getLocation().showEditor_()
    : a.isConnection() || b == Blockly.ASTNode.types.WORKSPACE
    ? Blockly.navigation.markAtCursor_()
    : b == Blockly.ASTNode.types.BLOCK
    ? Blockly.navigation.warn_("Cannot mark a block.")
    : b == Blockly.ASTNode.types.STACK &&
...
Blockly.navigation.ACTION_DISCONNECT = new Blockly.Action(
  ...
  "Dicsonnect the block at thecurrent location from its parent."
);
...
Blockly.Procedures.findLegalName = function(a, b) {
  ...
  for (
    a = a || Blockly.Msg.UNNAMED_KEY || "unnamed";
    !Blockly.Procedures.isLegalName_(a, b.workspace, b);
  ...
  if (!(Blockly.utils.isTargetInput(a) || (b.rendered && !b.isVisible())))
    if (b.options.readOnly) Blockly.navigation.onKeyPress(a);
      ...
      if (a.keyCode == Blockly.utils.KeyCodes.ESC)
        ...
        if (
          a.keyCode == Blockly.utils.KeyCodes.BACKSPACE ||
          a.keyCode == Blockly.utils.KeyCodes.DELETE
        ) {
          a.preventDefault();
          ...
          a.keyCode == Blockly.utils.KeyCodes.V
            ? Blockly.clipboardXml_ &&
              ...
              Blockly.clipboardTypeCounts_ &&
                ...
                Blockly.Events.setGroup(!1)))
            : a.keyCode == Blockly.utils.KeyCodes.Z &&
              (Blockly.hideChaff(), b.undo(a.shiftKey));
        }
      }
      c &&
        !Blockly.selected.workspace.isFlyout &&
...
Blockly.hideChaff = function(a) {
  ...
  a ||
    ...
    a.trashcan && a.trashcan.flyout_ && a.trashcan.flyout_.hide(),
    a.toolbox_ &&
      a.toolbox_.flyout_ &&
...
Blockly.Comment.prototype.createEditor_ = function() {
  ...
  var b = (this.textarea_ = document.createElementNS(
  ...
  Blockly.bindEventWithChecks_(b, "input", this, function(a) {
...
Blockly.Comment.prototype.createBubble_ = function() {
  !this.block_.isEditable() || Blockly.utils.userAgent.IE
...
Blockly.Comment.prototype.setBubbleSize = function(a, b) {
  this.bubble_
    ...
    : ((this.model_.size.width = a), (this.model_.size.height = b));
};
...
Blockly.tree.BaseNode.prototype.initAccessibility = function() {
  ...
  if (a) {
    ...
    b &&
      Blockly.utils.aria.setState(a, Blockly.utils.aria.State.LABELLEDBY, b.id);
    (b = this.getIconElement()) &&
      Blockly.utils.aria.setRole(b, Blockly.utils.aria.Role.PRESENTATION);
    if ((b = this.getChildrenElement()))
      if (
        (Blockly.utils.aria.setRole(b, Blockly.utils.aria.Role.GROUP),
        b.hasChildNodes())
      )
        for (
          Blockly.utils.aria.setState(a, Blockly.utils.aria.State.EXPANDED, !1),
...
Blockly.tree.BaseNode.prototype.setSelectedInternal = function(a) {
  if (this.selected_ != a) {
    ...
    var b = this.getElement();
    b &&
      (Blockly.utils.aria.setState(b, Blockly.utils.aria.State.SELECTED, a),
      a &&
  ...
  if (this.hasChildren()) {
    if ((!a && d && this.contains(d.getSelectedItem()) && this.select(), e)) {
      if ((c = this.getChildrenElement()))
        Blockly.utils.style.setElementShown(c, a),
          Blockly.utils.aria.setState(e, Blockly.utils.aria.State.EXPANDED, a),
          a &&
            this.isInDocument() &&
            !c.hasChildNodes() &&
            (this.forEachChild(function(a) {
    ...
    (c = this.getChildrenElement()) &&
      Blockly.utils.style.setElementShown(c, !1);
  e && this.updateIcon_();
...
Blockly.tree.BaseNode.prototype.getRowDom = function() {
  ...
  a.style["padding-" + (this.isRightToLeft() ? "right" : "left")] =
...
Blockly.tree.BaseNode.prototype.getElement = function() {
  ...
  a ||
    ((a = document.getElementById(this.getId())), this.setElementInternal(a));
  return a;
};
...
Blockly.tree.TreeNode.prototype.onKeyDown = function(a) {
  if (this.tree.toolbox_.horizontalLayout_) {
    ...
    Object.defineProperties(a, {
      keyCode: { value: b[a.keyCode] || a.keyCode }
    });
  }
...
Blockly.tree.TreeControl.prototype.setSelectedItem = function(a) {
  if (
    ...
    (!this.onBeforeSelected_ || this.onBeforeSelected_.call(this.toolbox_, a))
  ) {
...
Blockly.tree.TreeControl.prototype.handleKeyEvent_ = function(a) {
  var b = !1;
  if ((b = (this.selectedItem_ && this.selectedItem_.onKeyDown(a)) || b))
    Blockly.utils.style.scrollIntoContainerView(
  ...
  this.isBeingEdited_ &&
    ...
    this.isTextValid_
      ? (Blockly.utils.dom.removeClass(this.htmlInput_, "blocklyInvalidInput"),
        Blockly.utils.aria.setState(this.htmlInput_, "invalid", !1))
      : (Blockly.utils.dom.addClass(this.htmlInput_, "blocklyInvalidInput"),
        Blockly.utils.aria.setState(this.htmlInput_, "invalid", !0)));
};
...
Blockly.FieldAngle.prototype.onMouseMove = function(a) {
  ...
  b = Math.atan(-a / c);
  isNaN(b) ||
    ((b = Blockly.utils.math.toDegrees(b)),
    0 > c ? (b += 180) : 0 < a && (b += 360),
...
Blockly.FieldAngle.prototype.onHtmlInputKeyDown_ = function(a) {
  ...
  var b;
  a.keyCode === Blockly.utils.KeyCodes.LEFT
    ? (b = this.sourceBlock_.RTL ? 1 : -1)
    : a.keyCode === Blockly.utils.KeyCodes.RIGHT
    ? (b = this.sourceBlock_.RTL ? -1 : 1)
    : a.keyCode === Blockly.utils.KeyCodes.DOWN
    ? (b = -1)
    : a.keyCode === Blockly.utils.KeyCodes.UP && (b = 1);
  if (b) {
    var c = this.getValue();
...
Blockly.FieldCheckbox.prototype.setCheckCharacter = function(a) {
  this.checkChar_ = a;
  this.textContent_ &&
    (this.textContent_.nodeValue = a || Blockly.FieldCheckbox.CHECK_CHAR);
};
...
Blockly.FieldColour = function(a, b, c) {
  Blockly.FieldColour.superClass_.constructor.call(
    this,
    a || Blockly.FieldColour.COLOURS[0],
    b,
    c
  );
...
Blockly.FieldColour.prototype.configure_ = function(a) {
  ...
  a.colourOptions &&
    ((this.colours_ = a.colourOptions), (this.titles_ = a.colourTitles));
...
Blockly.FieldColour.prototype.moveHighlightBy_ = function(a, b) {
  ...
  0 > a
    ? 0 > e && 0 < f
      ...
      : 0 > e && (e = 0)
    : 0 < a
    ? e > d - 1 && f < Math.floor(c.length / d) - 1
      ? ((e = 0), f++)
      : e > d - 1 && e--
    : 0 > b
    ? 0 > f && (f = 0)
    : 0 < b &&
      f > Math.floor(c.length / d) - 1 &&
      (f = Math.floor(c.length / d) - 1);
...
Blockly.FieldColour.prototype.onMouseMove_ = function(a) {
  ...
  null !== b &&
    ...
    this.setHighlightedCell_(a, Number(b));
};
...
Blockly.FieldColour.prototype.dropdownCreate_ = function() {
  ...
  Blockly.utils.aria.setState(e, "colcount", a);
  for (var f, g = 0; g < b.length; g++) {
    ...
    b[g] == d &&
      ((h.className = "blocklyColourSelected"), (this.highlightedIndex_ = g));
  }
  this.onClickWrapper_ = Blockly.bindEventWithChecks_(
    e,
    "click",
...
Blockly.FieldDropdown.prototype.doValueUpdate_ = function(a) {
  ...
  a = this.getOptions(!0);
  for (var b = 0, c; (c = a[b]); b++)
    c[1] == this.value_ && (this.selectedIndex_ = b);
};
...
Blockly.FieldDropdown.prototype.render_ = function() {
  ...
  (a = 0 <= this.selectedIndex_ && a[this.selectedIndex_][0]) &&
  "object" == typeof a
    ? this.renderSelectedImage_(a)
...
Blockly.FieldDropdown.prototype.renderSelectedImage_ = function(a) {
  ...
  this.sourceBlock_.RTL
    ? ((a = Blockly.Field.DEFAULT_TEXT_OFFSET - 1),
      this.imageElement_.setAttribute(
        "x",
        Blockly.Field.DEFAULT_TEXT_OFFSET + b
      ),
      this.textElement_.setAttribute("x", a))
    : ((a = c + b + Blockly.Field.DEFAULT_TEXT_OFFSET + 1),
...
Blockly.FieldDropdown.prototype.renderSelectedText_ = function() {
  ...
  this.size_.width =
    Blockly.utils.dom.getTextWidth(this.textElement_) + Blockly.Field.X_PADDING;
};
...
Blockly.FieldMultilineInput.prototype.getDisplayText_ = function() {
  ...
  for (var c = 0; c < b.length; c++) {
    var d = b[c];
    d.length > this.maxDisplayLength &&
      (d = d.substring(0, this.maxDisplayLength - 4) + "...");
...
Blockly.FieldMultilineInput.prototype.render_ = function() {
  ...
  for (var b = Blockly.Field.Y_PADDING / 2, c = 0, d = 0; d < a.length; d++)
    Blockly.utils.dom
      .createSvgElement(
        "text",
        {
...
Blockly.FieldMultilineInput.prototype.updateSize_ = function() {
  for (
    var a = this.textGroup_.childNodes, b = 0, c = 0, d = 0;
    d < a.length;
    d++
  ) {
...
Blockly.FieldMultilineInput.prototype.onHtmlInputKeyDown_ = function(a) {
  a.keyCode !== Blockly.utils.KeyCodes.ENTER &&
    Blockly.FieldMultilineInput.superClass_.onHtmlInputKeyDown_.call(this, a);
};
Blockly.Css.register(
...
Blockly.FieldNumber.prototype.setPrecisionInternal_ = function(a) {
  null == a
    ? (this.precision_ = 0)
    : ((a = Number(a)), isNaN(a) || (this.precision_ = a));
...
Blockly.FieldVariable.prototype.fromXml = function(a) {
  ...
  b = Blockly.Variables.getOrCreateVariablePackage(
    this.sourceBlock_.workspace,
    b,
    c,
    d
...
Blockly.Flyout.prototype.createDom = function(a) {
  ...
  this.workspace_
    .getThemeManager()
    .subscribe(this.svgBackground_, "flyout", "fill");
  this.workspace_
    .getThemeManager()
...
Blockly.FlyoutButton = function(a, b, c, d) {
  ...
  this.isLabel_ = d;
  this.callbackKey_ =
    c.getAttribute("callbackKey") || c.getAttribute("callbackkey");
...
Blockly.FlyoutButton.prototype.createDom = function() {
  ...
  this.isLabel_ &&
    ...
    this.workspace_
      .getThemeManager()
      .subscribe(this.svgText_, "flyoutText", "fill"));
...
Blockly.VerticalFlyout.prototype.layout_ = function(a, b) {
  this.workspace_.scale = this.targetWorkspace_.scale;
  for (
    var c = this.MARGIN, d = this.RTL ? c : c + this.tabWidth_, e = 0, f;
    (f = a[e]);
    e++
  )
    if ("block" == f.type) {
  ...
  if (this.width_ != a) {
    ...
    if (this.RTL)
      for (c = 0; (d = this.buttons_[c]); c++)
        (b = d.getPosition().y),
          d.moveTo(
            a / this.workspace_.scale - d.width - this.MARGIN - this.tabWidth_,
            b
          );
    this.width_ = a;
    this.position();
...
Blockly.CursorSvg.HEIGHT_MULTIPLIER = 0.75;
...
Blockly.CursorSvg.prototype.createDom = function() {
  this.svgGroup_ = Blockly.utils.dom.createSvgElement(
    "g",
    {
      class: this.isMarker_
        ? Blockly.CursorSvg.MARKER_CLASS
        : Blockly.CursorSvg.CURSOR_CLASS
    },
    null
  );
...
Blockly.CursorSvg.prototype.setParent_ = function(a) {
  this.isMarker_
    ...
    : (this.parent_ && this.parent_.setCursorSvg(null),
      a.setCursorSvg(this.getSvgRoot()));
  this.parent_ = a;
};
Blockly.CursorSvg.prototype.showWithBlockPrevOutput_ = function(a) {
  if (a) {
    ...
    a.previousConnection
      ? this.positionPrevious_(b, e, d)
      : a.outputConnection
      ? this.positionOutput_(b, c)
      : this.positionBlock_(b, e, d);
    this.setParent_(a);
    this.showCurrent_();
  }
};
...
Blockly.CursorSvg.prototype.positionBlock_ = function(a, b, c) {
  a =
    Blockly.utils.svgPaths.moveBy(-1 * b, c) +
    Blockly.utils.svgPaths.lineOnAxis("V", -1 * b) +
    Blockly.utils.svgPaths.lineOnAxis("H", a + 2 * b) +
    Blockly.utils.svgPaths.lineOnAxis("V", c);
...
Blockly.CursorSvg.prototype.positionInput_ = function(a) {
  ...
  var c =
    Blockly.utils.svgPaths.moveTo(0, 0) + this.constants_.PUZZLE_TAB.pathDown;
  this.cursorInput_.setAttribute("d", c);
  this.cursorInput_.setAttribute(
    "transform",
    "translate(" +
      b +
      "," +
...
Blockly.CursorSvg.prototype.positionOutput_ = function(a, b) {
  var c =
    Blockly.utils.svgPaths.moveBy(a, 0) +
    Blockly.utils.svgPaths.lineOnAxis(
      "h",
      -1 * (a - this.constants_.PUZZLE_TAB.width)
    ) +
    Blockly.utils.svgPaths.lineOnAxis(
      "v",
    ...
    Blockly.utils.svgPaths.lineOnAxis("V", b) +
...
Blockly.CursorSvg.prototype.draw = function(a) {
  a
    ? a.getType() === Blockly.ASTNode.types.BLOCK
      ? ((a = a.getLocation()), this.showWithBlockPrevOutput_(a))
      : a.getType() === Blockly.ASTNode.types.OUTPUT
      ? ((a = a.getLocation().getSourceBlock()),
        this.showWithBlockPrevOutput_(a))
      : a.getLocation().type === Blockly.INPUT_VALUE
      ? this.showWithInput_(a)
      : a.getLocation().type === Blockly.NEXT_STATEMENT
      ? this.showWithNext_(a)
      : a.getType() === Blockly.ASTNode.types.PREVIOUS
      ? ((a = a.getLocation().getSourceBlock()),
        this.showWithBlockPrevOutput_(a))
      : a.getType() === Blockly.ASTNode.types.FIELD
      ? this.showWithField_(a)
      : a.getType() === Blockly.ASTNode.types.WORKSPACE
      ? this.showWithCoordinates_(a)
      : a.getType() === Blockly.ASTNode.types.STACK && this.showWithStack_(a)
    : this.hide();
};
Blockly.CursorSvg.prototype.createCursorSvg_ = function() {
  var a = this.isMarker_
    ? Blockly.CursorSvg.MARKER_COLOR
    : Blockly.CursorSvg.CURSOR_COLOR;
  this.cursorSvg_ = Blockly.utils.dom.createSvgElement(
    "g",
    {
  ...
  this.cursorSvgLine_ = Blockly.utils.dom.createSvgElement(
    "rect",
    {
      x: "0",
      y: "0",
  ...
  this.cursorSvgRect_ = Blockly.utils.dom.createSvgElement(
    "rect",
    {
...
Blockly.Mutator.prototype.workspaceChanged_ = function(a) {
  if (
    ...
    if (this.rootBlock_.workspace == this.workspace_) {
      ...
      a != b &&
        Blockly.keyboardAccessibilityMode &&
        Blockly.navigation.moveCursorOnBlockMutation(c);
...
Blockly.blockRendering.ConstantProvider.prototype.makeStartHat = function() {
  var a = this.START_HAT_HEIGHT,
    ...
    c = Blockly.utils.svgPaths.curve("c", [
      Blockly.utils.svgPaths.point(30, -a),
      Blockly.utils.svgPaths.point(70, -a),
  ...
  function a(a) {
    ...
    return (
      Blockly.utils.svgPaths.curve("c", [
        Blockly.utils.svgPaths.point(0, a * f),
        Blockly.utils.svgPaths.point(-b, d * l),
        m
      ]) +
      Blockly.utils.svgPaths.curve("s", [
        Blockly.utils.svgPaths.point(b, 2.5 * d),
        e
      ])
    );
  }
...
Blockly.blockRendering.ConstantProvider.prototype.makeNotch = function() {
  ...
  var b = this.NOTCH_WIDTH,
    ...
    e = a(1),
    f = a(-1);
  return { width: b, height: c, pathLeft: e, pathRight: f };
};
Blockly.blockRendering.ConstantProvider.prototype.makeInsideCorners = function() {
  var a = this.CORNER_RADIUS,
    b = Blockly.utils.svgPaths.arc(
      "a",
      "0 0,0",
      a,
      Blockly.utils.svgPaths.point(-a, a)
    ),
    c = Blockly.utils.svgPaths.arc(
      "a",
      "0 0,0",
      a,
      Blockly.utils.svgPaths.point(a, a)
...
Blockly.blockRendering.ConstantProvider.prototype.makeOutsideCorners = function() {
  var a = this.CORNER_RADIUS,
    b =
      Blockly.utils.svgPaths.moveBy(0, a) +
  ...
  a = Blockly.utils.svgPaths.arc(
    "a",
    "0 0,1",
    a,
    Blockly.utils.svgPaths.point(-a, -a)
  );
  return { topLeft: b, bottomLeft: a };
};
...
Blockly.blockRendering.Types.getType = function(a) {
  Blockly.blockRendering.Types.hasOwnProperty(a) ||
    ((Blockly.blockRendering.Types[a] =
...
Blockly.blockRendering.InputConnection = function(a, b) {
  ...
  if (
    (this.connectedBlock =
      b.connection && b.connection.targetBlock()
...
Blockly.blockRendering.InlineInput = function(a, b) {
  ...
  this.connectedBlock
    ...
    : ((this.height = this.constants_.EMPTY_INLINE_INPUT_HEIGHT),
      (this.width =
        this.shape.width + this.constants_.EMPTY_INLINE_INPUT_PADDING));
  this.connectionOffsetY = this.constants_.TAB_OFFSET_FROM_TOP;
...
Blockly.blockRendering.TopRow.prototype.hasLeftSquareCorner = function(a) {
  var b =
      (a.hat ? "cap" === a.hat : Blockly.BlockSvg.START_HAT) &&
      !a.outputConnection &&
      !a.previousConnection,
...
Blockly.blockRendering.InputRow.prototype.measure = function() {
  ...
  for (var a = 0, b = 0, c; (c = this.elements[b]); b++)
    (this.width += c.width),
      Blockly.blockRendering.Types.isInput(c) &&
        (Blockly.blockRendering.Types.isStatementInput(c)
          ? (a += c.connectedBlockWidth)
          : Blockly.blockRendering.Types.isExternalInput(c) &&
            0 != c.connectedBlockWidth &&
            (a += c.connectedBlockWidth - c.connectionWidth)),
      Blockly.blockRendering.Types.isSpacer(c) ||
...
Blockly.blockRendering.RenderInfo.prototype.createRows_ = function() {
  ...
  if (b.length)
    for (var c = 0, d; (d = b[c]); c++) {
      ...
      this.isCollapsed && d.collapseHidden
        ? this.hiddenIcons.push(e)
        : a.elements.push(e);
    }
  d = null;
  for (c = 0; (b = this.block_.inputList[c]); c++)
    if (b.isVisible()) {
      this.shouldStartNewRow_(b, d) &&
        (this.rows.push(a),
        (a = new Blockly.blockRendering.InputRow(this.constants_)));
      for (d = 0; (e = b.fieldRow[d]); d++)
        a.elements.push(
          new Blockly.blockRendering.Field(this.constants_, e, b)
        );
      this.addInput_(b, a);
      d = b;
    }
...
Blockly.blockRendering.RenderInfo.prototype.populateTopRow_ = function() {
  ...
  b
    ? ((a = new Blockly.blockRendering.Hat(this.constants_)),
      this.topRow.elements.push(a),
      (this.topRow.capline = a.ascenderHeight))
    : a &&
...
Blockly.blockRendering.RenderInfo.prototype.populateBottomRow_ = function() {
  ...
  this.bottomRow.minHeight =
    ...
    this.block_.inputList[this.block_.inputList.length - 1].type ==
      ...
      : this.constants_.MEDIUM_PADDING - 1;
...
Blockly.blockRendering.RenderInfo.prototype.addInput_ = function(a, b) {
  this.isInline && a.type == Blockly.INPUT_VALUE
    ? (b.elements.push(
        new Blockly.blockRendering.InlineInput(this.constants_, a)
      ),
      (b.hasInlineInput = !0))
    : a.type == Blockly.NEXT_STATEMENT
    ? (b.elements.push(
        new Blockly.blockRendering.StatementInput(this.constants_, a)
      ),
      (b.hasStatement = !0))
    : a.type == Blockly.INPUT_VALUE
    ? (b.elements.push(
        new Blockly.blockRendering.ExternalValueInput(this.constants_, a)
      ),
      (b.hasExternalInput = !0))
    : a.type == Blockly.DUMMY_INPUT && (b.hasDummyInput = !0);
};
Blockly.blockRendering.RenderInfo.prototype.shouldStartNewRow_ = function(
  ...
  return b
    ? a.type == Blockly.NEXT_STATEMENT || b.type == Blockly.NEXT_STATEMENT
      ? !0
      : a.type == Blockly.INPUT_VALUE || a.type == Blockly.DUMMY_INPUT
      ? !this.isInline
      : !1
    : !1;
};
Blockly.blockRendering.RenderInfo.prototype.addElemSpacing_ = function() {
  for (var a = 0, b; (b = this.rows[a]); a++) {
    ...
    for (var d = 0; d < c.length - 1; d++) {
      ...
      b.elements.push(
        new Blockly.blockRendering.InRowSpacer(this.constants_, e)
      );
    }
...
Blockly.blockRendering.RenderInfo.prototype.getInRowSpacing_ = function(a, b) {
  ...
  return a &&
    Blockly.blockRendering.Types.isLeftSquareCorner(a) &&
    b &&
    (Blockly.blockRendering.Types.isPreviousConnection(b) ||
      Blockly.blockRendering.Types.isNextConnection(b))
    ? b.notchOffset
    : a &&
      Blockly.blockRendering.Types.isLeftRoundedCorner(a) &&
      b &&
      (Blockly.blockRendering.Types.isPreviousConnection(b) ||
        Blockly.blockRendering.Types.isNextConnection(b))
...
Blockly.blockRendering.RenderInfo.prototype.alignStatementRow_ = function(a) {
  ...
  c = a.width;
  d =
    this.width - this.startX - (this.constants_.INSIDE_CORNERS.rightWidth || 0);
  b.width += d - c;
  a.width += d - c;
...
Blockly.blockRendering.RenderInfo.prototype.getElemCenterline_ = function(
  ...
  if (Blockly.blockRendering.Types.isBottomRow(a)) {
    ...
    return Blockly.blockRendering.Types.isNextConnection(b)
      ? c + b.height / 2
      : c - b.height / 2;
  }
  return Blockly.blockRendering.Types.isTopRow(a)
    ? Blockly.blockRendering.Types.isHat(b)
...
Blockly.blockRendering.Drawer.prototype.drawTop_ = function() {
  ...
  for (var c = 0, d; (d = b[c]); c++)
    Blockly.blockRendering.Types.isLeftRoundedCorner(d)
      ? (this.outlinePath_ += this.constants_.OUTSIDE_CORNERS.topLeft)
      : Blockly.blockRendering.Types.isPreviousConnection(d)
      ? (this.outlinePath_ += d.shape.pathLeft)
      : Blockly.blockRendering.Types.isHat(d)
      ? (this.outlinePath_ += this.constants_.START_HAT.path)
      : Blockly.blockRendering.Types.isSpacer(d) &&
        (this.outlinePath_ += Blockly.utils.svgPaths.lineOnAxis("h", d.width));
...
Blockly.blockRendering.Drawer.prototype.drawValueInput_ = function(a) {
  ...
  var c =
    "function" == typeof b.shape.pathDown
      ? b.shape.pathDown(b.height)
      : b.shape.pathDown;
  this.outlinePath_ +=
    Blockly.utils.svgPaths.lineOnAxis("H", b.xPos + b.width) +
    c +
    Blockly.utils.svgPaths.lineOnAxis("v", a.height - b.connectionHeight);
};
Blockly.blockRendering.Drawer.prototype.drawStatementInput_ = function(a) {
  ...
  this.outlinePath_ +=
    Blockly.utils.svgPaths.lineOnAxis("H", c) +
    b +
    Blockly.utils.svgPaths.lineOnAxis("v", d) +
...
Blockly.blockRendering.Drawer.prototype.drawBottom_ = function() {
  ...
  for (var c = b.length - 1, d; (d = b[c]); c--)
    Blockly.blockRendering.Types.isNextConnection(d)
      ? (this.outlinePath_ += d.shape.pathRight)
      : Blockly.blockRendering.Types.isLeftSquareCorner(d)
      ? (this.outlinePath_ += Blockly.utils.svgPaths.lineOnAxis("H", a.xPos))
      : Blockly.blockRendering.Types.isLeftRoundedCorner(d)
...
Blockly.blockRendering.Drawer.prototype.drawLeft_ = function() {
  ...
  if (a) {
    ...
    a =
      "function" == typeof a.shape.pathUp
...
Blockly.blockRendering.Drawer.prototype.drawInternals_ = function() {
  for (var a = 0, b; (b = this.info_.rows[a]); a++)
    for (var c = 0, d; (d = b.elements[c]); c++)
      Blockly.blockRendering.Types.isInlineInput(d)
        ? this.drawInlineInput_(d)
        : (Blockly.blockRendering.Types.isIcon(d) ||
            Blockly.blockRendering.Types.isField(d)) &&
          this.layoutField_(d);
};
Blockly.blockRendering.Drawer.prototype.layoutField_ = function(a) {
  ...
  var c = a.centerline - a.height / 2,
    ...
    e = "";
  this.info_.RTL &&
    ((d = -(d + a.width)), a.flipRtl && ((d += a.width), (e = "scale(-1 1)")));
  Blockly.blockRendering.Types.isIcon(a)
    ? (b.setAttribute("display", "block"),
      b.setAttribute("transform", "translate(" + d + "," + c + ")"),
      a.icon.computeIconLocation())
...
Blockly.blockRendering.Drawer.prototype.drawInlineInput_ = function(a) {
  ...
  this.inlinePath_ +=
    ...
    Blockly.utils.svgPaths.lineOnAxis("v", d) +
    a.shape.pathDown +
    Blockly.utils.svgPaths.lineOnAxis("v", c - e) +
    Blockly.utils.svgPaths.lineOnAxis("h", b - a.connectionWidth) +
    Blockly.utils.svgPaths.lineOnAxis("v", -c) +
    "z";
  this.positionInlineInputConnection_(a);
};
Blockly.blockRendering.Drawer.prototype.positionInlineInputConnection_ = function(
  a
) {
...
Blockly.blockRendering.Drawer.prototype.positionStatementInputConnection_ = function(
  a
) {
  var b = a.getLastInput();
  if (b.connection) {
...
Blockly.blockRendering.Drawer.prototype.positionExternalValueConnection_ = function(
  a
) {
  var b = a.getLastInput();
  if (b.connection) {
...
Blockly.blockRendering.Drawer.prototype.positionNextConnection_ = function() {
  ...
  if (a.connection) {
    a = a.connection;
    var b = a.xPos;
    a.connectionModel.setOffsetInBlock(
      this.info_.RTL ? -b : b,
      a.centerline - a.height / 2
    );
  }
};
...
Blockly.blockRendering.Renderer.prototype.render = function(a) {
  Blockly.blockRendering.useDebugger &&
    !a.renderingDebugger &&
    (a.renderingDebugger = this.makeDebugger_());
...
Blockly.geras.Highlighter.prototype.drawTopCorner = function(a) {
  ...
  for (var b = 0, c; (c = a.elements[b]); b++)
    Blockly.blockRendering.Types.isLeftSquareCorner(c)
      ? (this.steps_ += this.highlightConstants_.START_POINT)
      : Blockly.blockRendering.Types.isLeftRoundedCorner(c)
      ? (this.steps_ += this.outsideCornerPaths_.topLeft(this.RTL_))
      : Blockly.blockRendering.Types.isPreviousConnection(c)
      ...
      : Blockly.blockRendering.Types.isSpacer(c) &&
        ...
        (this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
          "H",
          c.xPos + c.width - this.highlightOffset_
        ));
  this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
    "H",
    a.xPos + a.width - this.highlightOffset_
  );
};
Blockly.geras.Highlighter.prototype.drawJaggedEdge_ = function(a) {
  this.info_.RTL &&
    ((this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
      "H",
      a.width - this.highlightOffset_
    )),
    (this.steps_ += this.jaggedTeethPaths_.pathLeft),
    (this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
      "v",
      a.height - this.jaggedTeethPaths_.height - this.highlightOffset_
    )));
};
Blockly.geras.Highlighter.prototype.drawValueInput = function(a) {
  ...
  if (this.RTL_) {
    ...
    this.steps_ +=
      Blockly.utils.svgPaths.moveTo(
        b.xPos + b.width - this.highlightOffset_,
        a.yPos
      ) +
    ...
    this.steps_ +=
      Blockly.utils.svgPaths.moveTo(b.xPos + b.width, a.yPos) +
      this.puzzleTabPaths_.pathDown(this.RTL_);
};
Blockly.geras.Highlighter.prototype.drawStatementInput = function(a) {
  ...
  if (this.RTL_) {
    ...
    this.steps_ +=
      Blockly.utils.svgPaths.moveTo(b.xPos, a.yPos) +
      this.insideCornerPaths_.pathTop(this.RTL_) +
      Blockly.utils.svgPaths.lineOnAxis("v", c) +
      this.insideCornerPaths_.pathBottom(this.RTL_) +
      Blockly.utils.svgPaths.lineTo(
        a.width - b.xPos - this.insideCornerPaths_.width,
        0
      );
  } else
    this.steps_ +=
      Blockly.utils.svgPaths.moveTo(b.xPos, a.yPos + a.height) +
      this.insideCornerPaths_.pathBottom(this.RTL_) +
      Blockly.utils.svgPaths.lineTo(
        a.width - b.xPos - this.insideCornerPaths_.width,
        0
...
Blockly.geras.Highlighter.prototype.drawRightSideRow = function(a) {
  ...
  a.followsStatement &&
    (this.steps_ += Blockly.utils.svgPaths.lineOnAxis("H", b));
  this.RTL_ &&
    ((this.steps_ += Blockly.utils.svgPaths.lineOnAxis("H", b)),
    a.height > this.highlightOffset_ &&
      (this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
        "V",
        a.yPos + a.height - this.highlightOffset_
      )));
};
Blockly.geras.Highlighter.prototype.drawBottomRow = function(a) {
  if (this.RTL_)
    this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
      "V",
      a.baseline - this.highlightOffset_
    );
  else {
    var b = this.info_.bottomRow.elements[0];
    Blockly.blockRendering.Types.isLeftSquareCorner(b)
      ? (this.steps_ += Blockly.utils.svgPaths.moveTo(
          a.xPos + this.highlightOffset_,
          a.baseline - this.highlightOffset_
        ))
      : Blockly.blockRendering.Types.isLeftRoundedCorner(b) &&
        ((this.steps_ += Blockly.utils.svgPaths.moveTo(a.xPos, a.baseline)),
...
Blockly.geras.Highlighter.prototype.drawLeft = function() {
  var a = this.info_.outputConnection;
  a &&
    ((a = a.connectionOffsetY + a.height),
    this.RTL_
      ? (this.steps_ += Blockly.utils.svgPaths.moveTo(this.info_.startX, a))
      : ((this.steps_ += Blockly.utils.svgPaths.moveTo(
  ...
  this.RTL_ ||
    ((a = this.info_.topRow),
    Blockly.blockRendering.Types.isLeftRoundedCorner(a.elements[0])
      ? (this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
          "V",
      ...
      : (this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
          "V",
          a.capline + this.highlightOffset_
        )));
};
Blockly.geras.Highlighter.prototype.drawInlineInput = function(a) {
  var b = this.highlightOffset_,
    ...
    f = d + b;
  this.RTL_
    ? ((d = a.connectionOffsetY - b),
      (a = a.height - (a.connectionOffsetY + a.connectionHeight) + b),
      (this.inlineSteps_ +=
        Blockly.utils.svgPaths.moveTo(c - b, f) +
        Blockly.utils.svgPaths.lineOnAxis("v", d) +
        this.puzzleTabPaths_.pathDown(this.RTL_) +
        Blockly.utils.svgPaths.lineOnAxis("v", a) +
        Blockly.utils.svgPaths.lineOnAxis("h", e)))
    : (this.inlineSteps_ +=
        Blockly.utils.svgPaths.moveTo(a.xPos + a.width + b, f) +
        Blockly.utils.svgPaths.lineOnAxis("v", a.height) +
        Blockly.utils.svgPaths.lineOnAxis("h", -e) +
        Blockly.utils.svgPaths.moveTo(c, d + a.connectionOffsetY) +
        this.puzzleTabPaths_.pathDown(this.RTL_));
};
...
Blockly.geras.RenderInfo.prototype.addInput_ = function(a, b) {
  this.isInline && a.type == Blockly.INPUT_VALUE
    ? (b.elements.push(new Blockly.geras.InlineInput(this.constants_, a)),
      (b.hasInlineInput = !0))
    : a.type == Blockly.NEXT_STATEMENT
    ? (b.elements.push(new Blockly.geras.StatementInput(this.constants_, a)),
      (b.hasStatement = !0))
    : a.type == Blockly.INPUT_VALUE
    ? (b.elements.push(
        new Blockly.blockRendering.ExternalValueInput(this.constants_, a)
...
Blockly.geras.RenderInfo.prototype.getInRowSpacing_ = function(a, b) {
  if (!a)
    return b && Blockly.blockRendering.Types.isField(b) && b.isEditable
      ? this.constants_.MEDIUM_PADDING
      : b && Blockly.blockRendering.Types.isInlineInput(b)
      ? this.constants_.MEDIUM_LARGE_PADDING
      : b && Blockly.blockRendering.Types.isStatementInput(b)
      ? this.constants_.STATEMENT_INPUT_PADDING_LEFT
      : this.constants_.LARGE_PADDING;
  if (!Blockly.blockRendering.Types.isInput(a) && !b)
    return Blockly.blockRendering.Types.isField(a) && a.isEditable
      ? this.constants_.MEDIUM_PADDING
      : Blockly.blockRendering.Types.isIcon(a)
      ? 2 * this.constants_.LARGE_PADDING + 1
      : Blockly.blockRendering.Types.isHat(a)
      ? this.constants_.NO_PADDING
      : Blockly.blockRendering.Types.isPreviousOrNextConnection(a)
      ? this.constants_.LARGE_PADDING
      : Blockly.blockRendering.Types.isLeftRoundedCorner(a)
      ? this.constants_.MIN_BLOCK_WIDTH
      : Blockly.blockRendering.Types.isJaggedEdge(a)
      ? this.constants_.NO_PADDING
      : this.constants_.LARGE_PADDING;
  if (Blockly.blockRendering.Types.isInput(a) && !b) {
    if (Blockly.blockRendering.Types.isExternalInput(a))
  ...
  if (
    !Blockly.blockRendering.Types.isInput(a) &&
    b &&
    Blockly.blockRendering.Types.isInput(b)
  ) {
    if (a.isEditable) {
      if (
        Blockly.blockRendering.Types.isInlineInput(b) ||
  ...
  if (
    ...
    return this.constants_.LARGE_PADDING;
  if (
    Blockly.blockRendering.Types.isInlineInput(a) &&
    b &&
    !Blockly.blockRendering.Types.isInput(b)
  )
    return b.isEditable
  ...
  if (Blockly.blockRendering.Types.isLeftRoundedCorner(a) && b) {
    ...
    if (Blockly.blockRendering.Types.isNextConnection(b))
      return (
        (c = ((this.RTL ? 1 : -1) * this.constants_.DARK_PATH_OFFSET) / 2),
        b.notchOffset - this.constants_.CORNER_RADIUS + c
      );
  }
  return (!Blockly.blockRendering.Types.isInput(a) &&
    b &&
    !Blockly.blockRendering.Types.isInput(b) &&
...
Blockly.geras.RenderInfo.prototype.addAlignmentPadding_ = function(a, b) {
  ...
  e
    ? e.align == Blockly.ALIGN_LEFT
      ? (d.width += b)
      : e.align == Blockly.ALIGN_CENTRE
      ? ((c.width += b / 2), (d.width += b / 2))
      : e.align == Blockly.ALIGN_RIGHT && (c.width += b)
    : (d.width += b);
  a.width += b;
};
Blockly.geras.RenderInfo.prototype.getSpacerRowHeight_ = function(a, b) {
  return Blockly.blockRendering.Types.isTopRow(a) &&
    Blockly.blockRendering.Types.isBottomRow(b)
    ? this.constants_.EMPTY_BLOCK_SPACER_HEIGHT
    : Blockly.blockRendering.Types.isTopRow(a) ||
      Blockly.blockRendering.Types.isBottomRow(b)
    ? this.constants_.NO_PADDING
    : a.hasExternalInput && b.hasExternalInput
    ? this.constants_.LARGE_PADDING
    : !a.hasStatement && b.hasStatement
    ? this.constants_.BETWEEN_STATEMENT_PADDING_Y
    : (a.hasStatement && b.hasStatement) || (!a.hasStatement && b.hasDummyInput)
    ? this.constants_.LARGE_PADDING
    : this.constants_.MEDIUM_PADDING;
};
Blockly.geras.RenderInfo.prototype.getElemCenterline_ = function(a, b) {
  ...
  if (Blockly.blockRendering.Types.isTopRow(a))
    return Blockly.blockRendering.Types.isHat(b)
      ? a.capline - b.height / 2
      : a.capline + b.height / 2;
  c = a.yPos;
  Blockly.blockRendering.Types.isField(b) ||
  Blockly.blockRendering.Types.isIcon(b)
    ? ((c += b.height / 2),
      (a.hasInlineInput || a.hasStatement) &&
        b.height + this.constants_.TALL_INPUT_FIELD_OFFSET_Y <= a.height &&
        (c += this.constants_.TALL_INPUT_FIELD_OFFSET_Y))
    : (c = Blockly.blockRendering.Types.isInlineInput(b)
        ? c + b.height / 2
        : c + a.height / 2);
  return c;
};
Blockly.geras.RenderInfo.prototype.finalize_ = function() {
  for (var a = 0, b = 0, c = 0, d; (d = this.rows[c]); c++) {
    ...
    d == this.bottomRow &&
      e < this.constants_.MIN_BLOCK_HEIGHT &&
      ((e = this.constants_.MIN_BLOCK_HEIGHT - e),
...
Blockly.geras.Drawer.prototype.draw = function() {
  ...
  this.drawOutline_();
  this.drawInternals_();
  this.block_.pathObject.setPaths(
    this.outlinePath_ + "\n" + this.inlinePath_,
...
Blockly.geras.Drawer.prototype.positionInlineInputConnection_ = function(a) {
  ...
  if (a.connection) {
    ...
    this.info_.RTL && (c *= -1);
    a.connection.setOffsetInBlock(
      c,
      b + a.connectionOffsetY + this.constants_.DARK_PATH_OFFSET
    );
  }
};
...
Blockly.geras.Drawer.prototype.positionNextConnection_ = function() {
  ...
  if (a.connection) {
    ...
    var b = a.xPos;
    a.connectionModel.setOffsetInBlock(
      (this.info_.RTL ? -b : b) + this.constants_.DARK_PATH_OFFSET / 2,
      a.centerline - a.height / 2 + this.constants_.DARK_PATH_OFFSET
    );
  }
};
...
Blockly.geras.HighlightConstantProvider.prototype.makeInsideCorner = function() {
  var a = this.constantProvider.CORNER_RADIUS,
    ...
    d =
      Blockly.utils.svgPaths.moveBy(c, c) +
      Blockly.utils.svgPaths.arc(
        "a",
        "0 0,0",
        a,
        Blockly.utils.svgPaths.point(-c - b, a - c)
      ),
    e = Blockly.utils.svgPaths.arc(
      "a",
      "0 0,0",
      a + b,
      Blockly.utils.svgPaths.point(a + b, a + b)
    ),
    f =
      Blockly.utils.svgPaths.moveBy(c, -c) +
      Blockly.utils.svgPaths.arc(
        ...
        "0 0,0",
        a + b,
        Blockly.utils.svgPaths.point(a - c, c + b)
      );
  return {
    width: a + b,
    height: a,
...
Blockly.geras.HighlightConstantProvider.prototype.makeOutsideCorner = function() {
  var a = this.constantProvider.CORNER_RADIUS,
    ...
    e =
      Blockly.utils.svgPaths.moveBy(b, a) +
      Blockly.utils.svgPaths.arc(
        "a",
        "0 0,1",
        a - b,
        Blockly.utils.svgPaths.point(a, -a + b)
      ),
    f = -c,
    g =
      Blockly.utils.svgPaths.moveBy(c, f) +
      Blockly.utils.svgPaths.arc(
        "a",
        "0 0,1",
        a - b,
        Blockly.utils.svgPaths.point(-c + b, -f - a)
      );
  return {
    height: a,
    topLeft: function(a) {
...
Blockly.geras.HighlightConstantProvider.prototype.makePuzzleTab = function() {
  var a = this.constantProvider.TAB_WIDTH,
    ...
    c =
      Blockly.utils.svgPaths.moveBy(-2, -b + 3.4) +
      Blockly.utils.svgPaths.lineTo(-0.45 * a, -2.1),
    d =
      Blockly.utils.svgPaths.lineOnAxis("v", 2.5) +
      Blockly.utils.svgPaths.moveBy(0.97 * -a, 2.5) +
      Blockly.utils.svgPaths.curve("q", [
        Blockly.utils.svgPaths.point(0.05 * -a, 10),
        Blockly.utils.svgPaths.point(0.3 * a, 9.5)
      ]) +
      Blockly.utils.svgPaths.moveBy(0.67 * a, -1.9) +
      Blockly.utils.svgPaths.lineOnAxis("v", 2.5),
    e =
      Blockly.utils.svgPaths.lineOnAxis("v", -1.5) +
      Blockly.utils.svgPaths.moveBy(-0.92 * a, -0.5) +
      Blockly.utils.svgPaths.curve("q", [
        Blockly.utils.svgPaths.point(-0.19 * a, -5.5),
        Blockly.utils.svgPaths.point(0, -11)
      ]) +
      Blockly.utils.svgPaths.moveBy(0.92 * a, 1),
    f =
      Blockly.utils.svgPaths.moveBy(-5, b - 0.7) +
      Blockly.utils.svgPaths.lineTo(0.46 * a, -2.1);
  return {
    width: a,
    height: b,
    pathUp: function(a) {
  ...
  var a = this.constantProvider.START_HAT.height,
    ...
    c =
      Blockly.utils.svgPaths.curve("c", [
        ...
        Blockly.utils.svgPaths.point(75, -8.7)
      ]) + Blockly.utils.svgPaths.moveTo(100.5, a + 0.5);
  return {
    path: function(a) {
      return a ? b : c;
    }
...
Blockly.Toolbox.prototype.handleAfterTreeSelected_ = function(a, b) {
  b && b.blocks && b.blocks.length
    ...
    : (this.flyout_.hide(),
      !Blockly.keyboardAccessibilityMode ||
        b instanceof Blockly.Toolbox.TreeSeparator ||
        Blockly.navigation.setState(Blockly.navigation.STATE_WS));
  if (a != b && a != this) {
    var c = new Blockly.Events.Ui(
      null,
      "category",
      a && a.getText(),
      b && b.getText()
...
Blockly.Toolbox.prototype.setColourFromStyle_ = function(a, b, c) {
  ...
  a &&
    d &&
    ((d = d.getCategoryStyle(a)) && d.colour
      ? this.setColour_(d.colour, b, c)
      : console.warn(
          'Style "' + a + '" must exist and contain a colour value'
        ));
};
...
Blockly.Trashcan.prototype.onDelete_ = function(a) {
  if (
    ...
    "shadow" != a.oldXml.tagName.toLowerCase() &&
    ((a = this.cleanBlockXML_(a.oldXml)), -1 == this.contents_.indexOf(a))
  ) {
    for (
      this.contents_.unshift(a);
