...
Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN = {
  ...
  getSurroundLoop: function(a) {
    do {
      if (
        -1 !=
        Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN.LOOP_TYPES.indexOf(
          a.type
        )
      )
        return a;
  ...
  onchange: function(a) {
    this.workspace.isDragging &&
      ...
      (Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN.getSurroundLoop(
        ...
        ? (this.setWarningText(null), this.isInFlyout || this.setEnabled(!0))
    ...
    if ("" == c.type) {
      ...
      for (
        ...
        this.argumentVarModels_[f].getId() == a &&
          ...
          (e = !0));
      e &&
        (this.displayRenamedVar_(c, d.name),
        Blockly.Procedures.mutateCallers(this));
    }
  },
    ...
    if (
      ...
      if (a.type == Blockly.Events.BLOCK_DELETE) {
        ...
        for (var d = 0; d < b.length; d += 1)
          b[d].getFieldValue("NAME") && a.push(b[d].getFieldValue("NAME"));
        for (b = 0; b < c.length; b += 1)
          -1 == a.indexOf(c[b].name) &&
            this.workspace.deleteVariableById(c[b].getId());
      } else if (
        a.type == Blockly.Events.BLOCK_CREATE &&
        ((c = this.workspace.getBlockById(a.blockId)),
        c.getField("NAME") &&
          ((d = c.getFieldValue("NAME")),
          (a = this.workspace.getVariable(d)) ||
            (a = this.workspace.createVariable(d)),
          !c.previousConnection.isConnected() &&
...
Blockly.Blocks.procedures_mutatorarg = {
  ...
  validator_: function(a) {
    ...
    if (!a) return null;
    b = b.workspace.getAllBlocks();
    for (var d = 0; d < b.length; d++)
      if (
        b[d].id != this.getSourceBlock().id &&
        b[d].getFieldValue("NAME") == a
      )
        return null;
    (b = c.getVariable(a, "")) &&
      b.name != a &&
...
Blockly.Constants.VariablesDynamic.RENAME_OPTION_CALLBACK_FACTORY = function(
  a
) {
  return function() {
    var b = a.workspace,
...
Blockly.Constants.VariablesDynamic.DELETE_OPTION_CALLBACK_FACTORY = function(
  a
) {
  return function() {
    var b = a.workspace,
