...
Blockly.JavaScript.scrub_ = function(a, b, c) {
  ...
  if (!a.outputConnection || !a.outputConnection.targetConnection) {
    ...
    e &&
      ((e = Blockly.utils.string.wrap(e, Blockly.JavaScript.COMMENT_WRAP - 3)),
    ...
    for (var f = 0; f < a.inputList.length; f++)
      a.inputList[f].type == Blockly.INPUT_VALUE &&
        ...
        (e = Blockly.JavaScript.allNestedComments(e)) &&
        (d += Blockly.JavaScript.prefixLines(e, "// "));
  }
...
Blockly.JavaScript.colour_picker = function(a) {
  return [
    Blockly.JavaScript.quote_(a.getFieldValue("COLOUR")),
...
Blockly.JavaScript.controls_if = function(a) {
  ...
  Blockly.JavaScript.STATEMENT_PREFIX &&
    (c += Blockly.JavaScript.injectId(Blockly.JavaScript.STATEMENT_PREFIX, a));
  do {
    var d =
      Blockly.JavaScript.valueToCode(
        a,
    ...
    Blockly.JavaScript.STATEMENT_SUFFIX &&
      (e =
        Blockly.JavaScript.prefixLines(
          Blockly.JavaScript.injectId(Blockly.JavaScript.STATEMENT_SUFFIX, a),
...
Blockly.JavaScript.controls_flow_statements = function(a) {
  var b = "";
  Blockly.JavaScript.STATEMENT_PREFIX &&
    (b += Blockly.JavaScript.injectId(Blockly.JavaScript.STATEMENT_PREFIX, a));
  Blockly.JavaScript.STATEMENT_SUFFIX &&
    (b += Blockly.JavaScript.injectId(Blockly.JavaScript.STATEMENT_SUFFIX, a));
...
Blockly.JavaScript.math_atan2 = function(a) {
  var b =
    Blockly.JavaScript.valueToCode(a, "X", Blockly.JavaScript.ORDER_COMMA) ||
    "0";
  return [
    "Math.atan2(" +
      (Blockly.JavaScript.valueToCode(a, "Y", Blockly.JavaScript.ORDER_COMMA) ||
        "0") +
      ", " +
      b +
      ") / Math.PI * 180",
...
Blockly.JavaScript.procedures_defreturn = function(a) {
  ...
  Blockly.JavaScript.STATEMENT_PREFIX &&
    (c += Blockly.JavaScript.injectId(Blockly.JavaScript.STATEMENT_PREFIX, a));
  Blockly.JavaScript.STATEMENT_SUFFIX &&
    (c += Blockly.JavaScript.injectId(Blockly.JavaScript.STATEMENT_SUFFIX, a));
  c && (c = Blockly.JavaScript.prefixLines(c, Blockly.JavaScript.INDENT));
  var d = "";
  Blockly.JavaScript.INFINITE_LOOP_TRAP &&
    (d = Blockly.JavaScript.prefixLines(
      Blockly.JavaScript.injectId(Blockly.JavaScript.INFINITE_LOOP_TRAP, a),
      Blockly.JavaScript.INDENT
    ));
...
Blockly.JavaScript.procedures_ifreturn = function(a) {
  var b =
    ...
    ") {\n";
  Blockly.JavaScript.STATEMENT_SUFFIX &&
    (b += Blockly.JavaScript.prefixLines(
      Blockly.JavaScript.injectId(Blockly.JavaScript.STATEMENT_SUFFIX, a),
      Blockly.JavaScript.INDENT
    ));
  a.hasReturnValue_
...
Blockly.JavaScript.text.forceString_ = function(a) {
  return Blockly.JavaScript.text.forceString_.strRegExp.test(a)
    ? a
    : "String(" + a + ")";
};
  ...
  switch (a.itemCount_) {
    ...
    case 1:
      return (
        ...
        (a = Blockly.JavaScript.text.forceString_(a)),
    ...
    case 2:
      ...
      a =
        Blockly.JavaScript.text.forceString_(b) +
        " + " +
